...
RegisterNetEvent("pierre_weapons:throwWeapon", function(data)
    local source = source
    ...
    TriggerClientEvent("pierre_weapons:setWeaponData", -1, weaponID, data)
end)

RegisterNetEvent("pierre_weapons:pickupWeapon", function(weaponID) 
    local source = source
    ...
    TriggerClientEvent("pierre_weapons:setWeaponData", -1, weaponID, nil)
end)
